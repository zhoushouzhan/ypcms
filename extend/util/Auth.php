...
-- ----------------------------
DROP TABLE IF EXISTS `yp_access`;
...
class Auth {
	...
	public function getGroups($uid) {
		...
		// 执行查询
		$user_groups = Db::view($auth_group_access, 'admin_id,roles_id')
			->view($auth_group, 'title,rules', "{$auth_group_access}.roles_id={$auth_group}.id", 'LEFT')
