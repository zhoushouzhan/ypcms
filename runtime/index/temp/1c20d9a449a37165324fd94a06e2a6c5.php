<?php /*a:3:{s:50:"F:\wwwroot\ypcms\view/pc\index\user\set_email.html";i:1654646150;s:42:"F:\wwwroot\ypcms\view/pc\index\layout.html";i:1654683557;s:45:"F:\wwwroot\ypcms\view/pc\index\user\menu.html";i:1654646150;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <title>设置邮箱 - <?php echo htmlspecialchars($site['sitename']); ?></title>
    ...
    <div class="user-main">
        <div class="layui-tab layui-tab-brief">
            ...
            <div class="layui-tab-content">
                <form class="layui-form layui-form-pane" action="<?php echo url('index/user/setEmail'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">当前邮箱</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" value="<?php echo htmlspecialchars($user['email']); ?>" disabled>
                        </div>
                    </div>
                    <div class="layui-form-item">
