<?php /*a:2:{s:47:"F:\wwwroot\ypcms\view/pc\index\index\index.html";i:1654735859;s:42:"F:\wwwroot\ypcms\view/pc\index\layout.html";i:1654736262;}*/ ?>
<!--
 * @Author: 一品网络技术有限公司
...
<div class="article">
  <div class="layui-main">
    <div class="h-box">
      <div class="h-tit">最新文章</div>
    </div>
    <div class="h-con">
      <ul class="clearfix">
        <?php $_result=model('article','',2);if(is_array($_result) || $_result instanceof \think\Collection || $_result instanceof \think\Paginator): $i = 0; $__LIST__ = $_result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
        <li>
          <div class="titlepic">
