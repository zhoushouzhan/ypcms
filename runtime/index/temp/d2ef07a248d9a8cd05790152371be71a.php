<?php /*a:3:{s:51:"F:\wwwroot\ypcms\view/pc\index\user\set_mobile.html";i:1654646150;s:42:"F:\wwwroot\ypcms\view/pc\index\layout.html";i:1654683557;s:45:"F:\wwwroot\ypcms\view/pc\index\user\menu.html";i:1654646150;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
    ...
    <title>设置手机号码 - <?php echo htmlspecialchars($site['sitename']); ?></title>
    ...
    <div class="user-main">
        <div class="layui-tab layui-tab-brief">
            <ul class="layui-tab-title">
                <li class="layui-this">设置手机号码</li>
            </ul>
            <div class="layui-tab-content">
                <form class="layui-form layui-form-pane" action="<?php echo url('index/user/setmobile'); ?>" method="post">
                    <div class="layui-form-item">
                        <label class="layui-form-label">当前手机号</label>
                        <div class="layui-input-inline">
                            <input type="text" class="layui-input" value="<?php echo htmlspecialchars(hidePhone($user['mobile'])); ?>" disabled>
                        </div>
                    </div>
                    <div class="layui-form-item">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <button type="button" class="layui-btn layui-bg-black changeCode" data-url="<?php echo url('index/user/changeCode'); ?>">免费获取验证码</button>
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <div class="layui-input-block">
