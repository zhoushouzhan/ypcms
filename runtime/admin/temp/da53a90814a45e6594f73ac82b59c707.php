<?php /*a:1:{s:49:"F:\wwwroot\ypcms\app\admin\view\public\error.html";i:1635867429;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
		...
		<ul class="site-idea">
		    <li>
		        <fieldset class="layui-elem-field layui-field-title">
		            <p align="center" style="color: red;"><i class="layui-icon layui-icon-face-cry" style="font-size: 50px"></i></p>
		            <p align="center" style="line-height: 33px;color: red;font-weight: bold;font-size: 22px;padding-top: 20px;"><?php echo htmlspecialchars($msg); ?></p>
		            <p class="jump">
		                <b id="wait"><?php echo htmlspecialchars($wait); ?></b> 秒后页面将自动跳转
		            </p>
		            <hr>
		            <p align="right">
		                <a href="<?php echo htmlspecialchars($url); ?>" id="href" class="layui-btn layui-bg-blue">立即跳转</a>
		            </p>
		        </fieldset>
		    </li>
		</ul> 
