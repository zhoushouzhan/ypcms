<?php /*a:2:{s:47:"F:\wwwroot\ypcms\app\admin\view\ypmod\edit.html";i:1653223506;s:41:"F:\wwwroot\ypcms\app\admin\view\base.html";i:1636685215;}*/ ?>
<!DOCTYPE html>
<html lang="zh-CN">
<head>
    <meta charset="UTF-8">
        ...
        <form action="<?php echo url('update'); ?>" method="post" id="f1">
            ...
            <div class="layui-form-pane">
                ...
                <div class="layui-inline <?php if(!$r['node_id']): ?>layui-hide<?php endif; ?>" id="nodeSort">
                    <div class="layui-input-inline">
                        <input type="number" name="nodesort" value="<?php echo htmlspecialchars($r['nodesort']); ?>" class="layui-input" placeholder="节点序号">
                    </div>
                </div>
