<?php /*a:2:{s:46:"F:\wwwroot\ypcms\app\admin\view\ypmod\add.html";i:1654677871;s:41:"F:\wwwroot\ypcms\app\admin\view\base.html";i:1654652765;}*/ ?>
<!--
 * @Author: 一品网络技术有限公司
        ...
        <div class="layui-inline">
          <div class="layui-input-inline">
            <select name="menu" id="menu">
              <option value="0">后台不能录入</option>
              <option value="1">后台可录入</option>
            </select>
          </div>
        </div>
      </div>
